...
Format notes, the fidelity docket, and other working documentation for
Restrike.
...
- Format notes for DAX/ECL/GEO and other data formats land here as they're
  reverse-engineered, cross-referenced in [`../SOURCES.md`](../SOURCES.md).

See [`../PLAN.md`](../PLAN.md) for the overall project plan and
